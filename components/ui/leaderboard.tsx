 ...
 * - Reactions: 2 points per reaction received
 * - Thread Creation: 15 points per thread
 * - Active Participation: 1 point per day of activity
 * 
 * Total Score = (Posts × 10) + (Comments × 5) + (Reactions × 2) + (Threads × 15) + (Active Days)
 */
