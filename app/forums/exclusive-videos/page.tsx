...
const categoryData: CategoryInfo = {
  ...
  description: "Premium video content for exclusive members",
  parent: "exclusive"
}
...
const generateMockThreads = (): Thread[] => {
  ...
  for (let i = 1; i <= 10; i++) {
    ...
    threads.push({
      id: i,
      title: `${i % 2 === 0 ? "📱" : "🔥"} Exclusive Video Content #${i} - ${
        i % 3 === 0 ? "MEGA Collection" : "Latest Release"
      } ${i % 4 === 0 ? "🔥🔥" : ""}`,
      author: {
        name: `ExclusiveUser${i}`,
        avatar: `/abstract-geometric-shapes.png?height=40&width=40&query=exclusiveAvatar${i}`,
      },
      date: `${month} ${day}, 2023`,
      replies,
      views,
      likes,
      lastReply: {
        author: `Exclusive${i * 10}`,
        avatar: `/abstract-geometric-shapes.png?height=40&width=40&query=exclusiveReply${i}`,
      ...
      isHot,
      isNew,
      thumbnail: `/abstract-geometric-shapes.png?height=80&width=80&query=exclusive${i}`,
    })
  }
...
const threads = generateMockThreads()
  ...
  const breadcrumbs = [
    ...
    { name: "Exclusive", href: "/forums/exclusive" },
  { name: "Exclusive Videos", href: "/forums/exclusive-videos" }
]
